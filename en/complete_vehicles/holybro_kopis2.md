...
Instructions for installing the bootloader can be found in the [Kakute F7](../flight_controller/kakutef7.md#betaflight_configurator) topic (this is the flight controller board on the *Kopis 2*).

> **Tip** You can always [reinstall Betaflight](../flight_controller/kakutef7.md#reinstall_betaflight) later if you want!
